      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="mt-2">
            ...
            Оператор может получить о посетителях веб-сайта https://сайт.ru.
          </p>

          <h2 className="text-xl font-semibold mt-4">2. Основные понятия</h2>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            доступность в сети интернет по сетевому адресу https://сайт.ru.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            2.10. Пользователь — любой посетитель веб-сайта https://сайт.ru.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">4.1. Субъекты персональных данных имеют право:</p>
          <p className="ml-4">
          ...
          <p className="mt-2">4.2. Субъекты персональных данных обязаны:</p>
          <p className="ml-4">
          ...
          <p className="mt-2">Персональные данные:</p>
          <p className="ml-4">— фамилия, имя, отчество;</p>
          <p className="ml-4">— электронный адрес;</p>
          <p className="ml-4">— номера телефонов;</p>

          <p className="mt-2">Правовые основания:</p>
          <p className="ml-4">
            Федеральный закон «Об информации, информационных технологиях и о
            защите информации» от 27.07.2006 N 149-ФЗ.
          </p>

          <p className="mt-2">Виды обработки персональных данных:</p>
          <p className="ml-4">
          ...
          <p className="mt-2">
            ...
            Оператора адрес@почты.ком с пометкой «Актуализация персональных
            данных».
          </p>
          <p className="mt-2">
            ...
            адрес@почты.ком с пометкой «Отзыв согласия на обработку персональных
            данных».
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            к Оператору с помощью электронной почты ispp.ea@gmail.com.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            сети Интернет по адресу https://сайт.ru/privacy.
          </p>
        </CardContent>
      </Card>
    </div>
